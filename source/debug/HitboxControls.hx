...
class Hitbox extends FlxSpriteGroup {
	...
	public function new(?widghtScreen:Float) {
		...
		var hitbox_hint:FlxSprite = new FlxSprite(0, 0).loadGraphic('assets/images/mobile stuff/hitbox_hint.png');
	...
	public function createhitbox(X:Float, framestring:String) {
		...
		var frames = FlxAtlasFrames.fromSparrow('assets/images/mobile stuff/hitbox.png', 'assets/images/mobile stuff/hitbox.xml');
